...
public class ResourceLoader {
   ...
   * @param filter Filter for loaded texture.
  ...
  public static Texture scaleTexture(FileHandle file, int width, int height, Filter filter) {
    ...
    scaledImage.drawPixmap(originalImage, 0, 0, originalImage.getWidth(), originalImage.getHeight(),
        0, 0, scaledImage.getWidth(), scaledImage.getHeight());
