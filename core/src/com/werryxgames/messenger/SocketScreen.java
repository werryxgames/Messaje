...
public interface SocketScreen extends Screen
{
     ...
     * Exists, because some operations (for example loading resources) can be done only in main thread,
     * but constructor can be called in non-main thread.
     *
     * @since 1.0
     */
    void init();
     ...
     *
     * @param code
     *     Code of websocket message.
     * @param message
     *     Websocket message. It is always ByteBuffer, sought to position 4.
     * @since 1.0
     */
