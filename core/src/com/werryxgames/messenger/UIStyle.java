...
public class UIStyle
{
    ...
    public static void create()
    {
        ...
        textFieldStyle.selection = new TextureRegionDrawable(
            ResourceLoader.loadTexture(Gdx.files.internal("ui" + File.separator + "input_selection.png"))
        );
        ...
        textFieldStyle.focusedBackground = new NinePatchDrawable(
            new NinePatch(
                ResourceLoader.loadTexture(Gdx.files.internal("ui" + File.separator + "input_focused.png")),
                9,
                10,
                9,
                10
        ...
        scrollPaneStyle.background = new NinePatchDrawable(
            new NinePatch(
                ResourceLoader.loadTexture(Gdx.files.internal("ui" + File.separator + "scrollpane.png")),
                1,
                1,
                1,
                1
        ...
        scrollPaneStyle.hScroll = new NinePatchDrawable(
            new NinePatch(
                ResourceLoader.loadTexture(Gdx.files.internal("ui" + File.separator + "scrollpane_hscroll.png")),
                1,
                1,
                1,
                1
        ...
        scrollPaneStyle.vScroll = new NinePatchDrawable(
            new NinePatch(
                ResourceLoader.loadTexture(Gdx.files.internal("ui" + File.separator + "scrollpane_vscroll.png")),
                1,
                1,
                1,
                1
        ...
        scrollPaneStyle.hScrollKnob = new NinePatchDrawable(
            new NinePatch(
                ResourceLoader.loadTexture(Gdx.files.internal("ui" + File.separator + "scrollpane_hscrollknob.png")),
                1,
                1,
                1,
                1
        ...
        scrollPaneStyle.vScrollKnob = new NinePatchDrawable(
            new NinePatch(
                ResourceLoader.loadTexture(Gdx.files.internal("ui" + File.separator + "scrollpane_vscrollknob.png")),
                1,
                1,
                1,
                1
        ...
        scrollPaneStyle.corner = new TextureRegionDrawable(
            ResourceLoader.loadTexture(Gdx.files.internal("ui" + File.separator + "scrollpane_corner.png"))
        );
    }
     ...
     *
     * @param fontType
     *     fontId for {@link FontManager}.
     * @param fontSize
     *     font size for {@link FontManager}.
     * @return Style.
     * @since 1.0
     */
    public static TextFieldStyle getTextFieldStyle(FontManager fontManager, int fontType, int fontSize)
    {
     ...
     * @since 1.0
     */
    public static TextButtonStyle getTextButtonStyle(FontManager fontManager, int fontType, int fontSize)
    {
     ...
     * @since 1.0
     */
    public static TextButtonStyle getTextButtonStyleDisabled(FontManager fontManager, int fontType, int fontSize)
    {
